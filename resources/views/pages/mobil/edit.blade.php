                            ...
                            <form action="/mobil/{{ $mobil->id }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12 px-4">
                                        ...
                                        <div class="form-group">
                                            <label for="title">nomor_plat</label>
                                            <input type="text" name="nomor_plat"
                                                class="form-control @error('nomor_plat') is-invalid @enderror"
                                                id="title" placeholder="input nomor_plat" autocomplete="off" required
                                        ...
                                        <div class="form-group">
                                            <label for="title">tarif_perhari</label>
                                            <input type="text" name="tarif_perhari"
                                                class="form-control @error('tarif_perhari') is-invalid @enderror"
                                                id="title" placeholder="input tarif_perhari" autocomplete="off" required
                                                value="{{ old('tarif_perhari', $mobil->tarif_perhari) }}">
                                            @error('tarif_perhari')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
